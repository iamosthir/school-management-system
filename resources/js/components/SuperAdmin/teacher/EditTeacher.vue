            ...
            <div class="card-body">
                ...
                <form @submit.prevent="updateTeacher" class="row">
                    <div class="col-md-12 mb-4">
                        <router-link :to="{name: 'admin.assign-class', params: {teacherId: $route.params.teacherId}}" class="btn btn-outline-dark">Assign Class <i class="fas fa-plus"></i></router-link>
                    </div>
                    <div class="col-md-4 mb-4">
                        <label for="">Select School</label>
                        <multiselect :class="{'is-invalid': form.errors.has('schoolId')}" v-model="selectedSchool" :options="schools" :preserve-search="true" placeholder="Select section" label="name" track-by="id"></multiselect>
